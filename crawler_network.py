...
- 뉴스 앵커의 차분하고 격식 있는 구어체 존댓말로 작성. 문어체 나열이 아니라 사람이 말하듯 자연스럽게, 문장은 짧게 끊고 소식 사이에는 "다음 소식입니다", "이어서" 같은 전환어 사용
...
- 영문 회사명과 약어는 한글 발음으로 표기 (예: 에릭슨, 버라이즌, 티모바일, 에프씨씨), 숫자와 단위도 읽히는 대로 자연스럽게
